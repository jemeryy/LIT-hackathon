...
Status: v4, 5 Sep 2026 ~15:30 SGT, after team feedback and a check against the CJTS filing guide. Figures checked against the State Courts
...
| 10-22 | Guided intake. 8 plain questions with uploads inline ("Upload the tenancy agreement", "Upload the chat"). | No legal words. Every question says why it is asked. Her answers are her account. Only files are evidence. |
...
| 55-67 | Evidence blind spots. Left: what the landlord could bring (his photos, a repair invoice, the signed inventory, messages on other channels, a counterclaim) and what covers each. Right: four questions for what she may have missed (other agreed conditions, signed handover form, witnesses, any deduction accepted). | This is the confirmation-bias fix the brief asks for. We do not argue his case. We list what could exist so she is not surprised at the Consultation. |
...
- Real: upload, extraction with source locations, ranked evidence table with click-to-highlight,
...
- Stubbed: CJTS portal submission (no public API). Corpus is ~40 sections plus the court guide, not all of Singapore law.
...
- Demo scenario switched from renovation to a tenancy deposit, since the team wants tenancy and sales.
  Sale of goods is the second supported claim type; the gap list and gate change with claim type.
...
Intake form, sample pack, parser for PDF / WhatsApp txt / images, fact extractor with source
